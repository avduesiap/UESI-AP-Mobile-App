...
import MaterialsScreen from './song-book/MaterialsScreen';
import PdfViewScreen from './song-book/PdfViewScreen';
import HistoricalDatesScreen from './song-book/HistoricalDatesScreen';
import MagazineListScreen from './Velugu/MagazineListScreen';
...
const DrawerNavigator = () => {
    return (
        ...
        <Drawer.Screen name="Calendar" component={CalendarScreen}  options={{
          ...
          <Drawer.Screen name="HistoricalDatesScreen" component={HistoricalDatesScreen}  options={{
            drawerLabel: 'Historical Dates & Events',
            title: 'Historical Dates & Events',
            groupName: 'historical-dates-events',
            headerStyle: {
                backgroundColor: Colors().themeColor,
            },
            headerTintColor: '#fff',
    ...
    return (
        <NavigationContainer ref={navigationRef}>
            <Stack.Navigator initialRouteName="SplashScreen">
                ...
                <Stack.Screen name="PdfViewScreen" component={PdfViewScreen} options={({ navigation, route }) =>({
                    headerShown: false,
                    headerStyle: {
                        backgroundColor: Colors().themeColor,
                    },
                    headerTintColor: '#fff',
                    headerTitle: 'View Pdf',
                    headerTitleStyle: {
                        fontWeight: 'bold',
                    }
                })} />
                ...
                <Stack.Screen name="AlbumSongScreen" component={AlbumSongScreen} options={{
                    headerShown: true,
                    headerStyle: {
                        backgroundColor: Colors().themeColor,
                    },
                ...
                <Stack.Screen name="AlbumSongsListScreen" component={AlbumSongsListScreen} options={{
                    headerShown: true,
                    headerStyle: {
                        backgroundColor: Colors().themeColor,
                    },
