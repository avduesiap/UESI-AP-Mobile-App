...
const prepareMaterialsGroup = (value) => {
  return state.routes?.map((route, index) => {
    const {
      drawerLabel,
      activeTintColor,
    ...
    <DrawerItem
        ...
        label={
          ...
          <>
          <View style={styles.accordHeader1}>
            <Icon style={{paddingRight:15,width:40,textAlign:'right'}} name='file-word-o' size={28} color="#FFFFFF" />
              <View style={{flex: 1,flexDirection: 'row', justifyContent:'space-between'}}>
              <Text style={{color:'#FFFFFF',fontSize:16, marginLeft:3, marginTop:2, fontFamily:Fonts.Font_Medium}}>{drawerLabel}</Text>
              </View>
              </View>
...
const prepareHistoricalDatesEventsGroup = (value) => {
  return state.routes?.map((route, index) => {
    const {
      drawerLabel,
      activeTintColor,
    ...
    <DrawerItem
        ...
        label={
          ...
          <>
          <View style={styles.accordHeader1}>
            <Icon style={{paddingRight:15,width:40,textAlign:'right'}} name='calendar' size={28} color="#FFFFFF" />
              <View style={{flex: 1,flexDirection: 'row', justifyContent:'space-between'}}>
              <Text style={{color:'#FFFFFF',fontSize:16, marginLeft:3, marginTop:2, fontFamily:Fonts.Font_Medium}}>{drawerLabel}</Text>
              </View>
              </View>
...
const prepareJobPortalGroup = (value) => {
  return state.routes?.map((route, index) => {
    const {
      drawerLabel,
      activeTintColor,
    ...
    <DrawerItem
        ...
        label={
          ...
          <>
          <View style={styles.accordHeader1}>
            <Icon style={{paddingRight:5, width:40,textAlign:'right'}} name='graduation-cap' size={25} color="#FFFFFF" />
              <View style={{flex: 1,flexDirection: 'row', justifyContent:'space-between'}}>
                <Text style={{color:'#FFFFFF',fontSize:16, marginLeft:3, marginTop:2, fontFamily:Fonts.Font_Medium}}>{drawerLabel}</Text>
              </View>
              </View>
...
const openJobPortal = ()=>{
  Linking.openURL('https://careers.uesits.com/')
}
_googleAuth = async () => {
...
const prepareMusicAlbumsGroup = (value) => {
  return state.routes?.map((route, index) => {
    const {
      drawerLabel,
      activeTintColor,
    ...
    <DrawerItem
        ...
        label={
          ...
          <>
          <View style={styles.accordHeader1}>
            <Icon style={{paddingRight:15,width:40,textAlign:'right'}} name='music' size={27} color="#FFFFFF" />
              <View style={{flex: 1,flexDirection: 'row', justifyContent:'space-between'}}>
                <Text style={{color:'#FFFFFF',fontSize:16, marginLeft:3, marginTop:2, fontFamily:Fonts.Font_Medium}}>{drawerLabel}</Text>
              </View>
              </View>
