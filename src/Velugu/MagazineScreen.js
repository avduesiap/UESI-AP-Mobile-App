...
function MagazineScreen(props,{ route, navigation }) {
    ...
    useFocusEffect(
        useCallback(() => {
            ...
            const { magazineLink } = props.route.params;
            // if(magazineType === 'vidyarthi-velugu'){
            //     url = 'https://app.uesits.com/magazines/vidyarthi-velugu/full-edition/09-2023.pdf';
            // }else if(magazineType === 'campus-connect'){
            //     url = 'https://app.uesits.com/magazines/campus-connect/09-2023.pdf';
            // }else if(magazineType === 'in-touch'){
            //     url = 'https://app.uesits.com/magazines/in-touch/09-2023.pdf';
            // }else if(magazineType === 'our-field'){
            //     url = 'https://app.uesits.com/magazines/our-field/09-2023.pdf';
            // }else{
            //     url = '';
            // }
            setPdfUrl(magazineLink);
        //});
