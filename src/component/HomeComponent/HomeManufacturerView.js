        ...
        <View>
            ...
            <FlatList
                ...
                renderItem={({ item, index }) =>
                    <TouchableOpacity style={styles.catBox} key={item.id} onPress={() => props.navigation.navigate('ProductListScreen', { type: 'menufacturer', id: item.id, title: item.name })}>
                        <View style={styles.imageContainer}>
                            <Image source={{ uri: ASSETS_DIR + 'manufacturer/' + item.image }} style={styles.imageView} resizeMode='contain'
                            ></Image>
                        </View>
