...
function UESIHomeScreen(props) {
    ...
    const accordionHandlePressDynamic = (events, selectedEvent) => {
        ...
        //accordionHandlePress('','');
    }
    const accordionHandlePress = (type, value) => {
        setExpanded1(false); setExpanded2(false); setExpanded3(false); setExpanded4(false); setExpanded5(false); setExpanded6(false); setExpanded7(false); setExpanded8(false); setExpanded9(false); setExpanded10(false); setExpanded11(false); setExpanded12(false); setExpanded13(false); setExpanded14(false); setExpanded15(false); setExpanded16(false); setExpanded17(false); setExpanded18(false); setExpanded19(false); setExpanded20(false); setExpanded21(false); setExpanded21(false); setExpanded23(false);
        "expanded1"===type?setExpanded1(!value):"expanded2"===type?setExpanded2(!value):"expanded3"===type?setExpanded3(!value):"expanded4"===type?setExpanded4(!value):"expanded5"===type?setExpanded5(!value):"expanded6"===type?setExpanded6(!value):"expanded7"===type?setExpanded7(!value):"expanded8"===type?setExpanded8(!value):"expanded9"===type?setExpanded9(!value):"expanded10"===type?setExpanded10(!value):"expanded11"===type?setExpanded11(!value):"expanded12"===type?setExpanded12(!value):"expanded13"===type?setExpanded13(!value):"expanded14"===type?setExpanded14(!value):"expanded15"===type?setExpanded15(!value):"expanded16"===type?setExpanded16(!value):"expanded17"===type?setExpanded17(!value):"expanded18"===type?setExpanded18(!value):"expanded19"===type?setExpanded19(!value):"expanded20"===type?setExpanded20(!value):"expanded21"===type?setExpanded21(!value):"expanded22"===type?setExpanded22(!value):"expanded23"===type&&setExpanded23(!value);
    };
...
{/* <View>
        <Card mode="outlined">
            ...
            {UESIhistoricalEventsDates.length>0?UESIhistoricalEventsDates.map((data,i)=>{
                    ...
                    onPress={()=>{accordionHandlePressDynamic(UESIhistoricalEventsDates,data),accordionHandlePress('','')}}
       ...
       <View>
        <Card mode="outlined">
            ...
            <Card.Content>
                <List.Accordion expanded={expanded3} style={styles.ListAccordion}
                    title="1. Evangelism" 
                    onPress={()=>{accordionHandlePress('expanded3',expanded3),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                ...
                <List.Accordion expanded={expanded4} style={styles.ListAccordion}
                    title="2. Fellowship"
                    onPress={()=>{accordionHandlePress('expanded4',expanded4),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
                ...
                <OtrixDivider></OtrixDivider>
                <List.Accordion expanded={expanded5} style={styles.ListAccordion}
                    title="3. Testimony"
                    onPress={()=>{accordionHandlePress('expanded5',expanded5),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
                ...
                <OtrixDivider></OtrixDivider>
                <List.Accordion  expanded={expanded6} style={styles.ListAccordion}
                    title="4. Missions"
                    onPress={()=>{accordionHandlePress('expanded6',expanded6),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
       ...
       <View>
        <Card mode="outlined">
            ...
            <Card.Content>
                <List.Accordion  expanded={expanded7} style={styles.ListAccordion}
                    title="Introduction"
                    onPress={()=>{accordionHandlePress('expanded7',expanded7),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
                ...
                <OtrixDivider></OtrixDivider>
                <List.Accordion  expanded={expanded8} style={styles.ListAccordion}
                    title="1. Centrality Of The Word Of God"
                    onPress={()=>{accordionHandlePress('expanded8',expanded8),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
                ...
                <OtrixDivider></OtrixDivider>
                <List.Accordion  expanded={expanded9}  style={styles.ListAccordion}
                    title="2. Relationship With God"
                    onPress={()=>{accordionHandlePress('expanded9',expanded9),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
                ...
                <OtrixDivider></OtrixDivider>
                <List.Accordion  expanded={expanded10} style={styles.ListAccordion}
                    title="3. Fellowship"
                    onPress={()=>{accordionHandlePress('expanded10',expanded10),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
                ...
                <OtrixDivider></OtrixDivider>
                <List.Accordion  expanded={expanded11} style={styles.ListAccordion}
                    title="4. Personal Care"
                    onPress={()=>{accordionHandlePress('expanded11',expanded11),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
                ...
                <OtrixDivider></OtrixDivider>
                <List.Accordion  expanded={expanded12} style={styles.ListAccordion}
                    title="5. Student Initiative"
                    onPress={()=>{accordionHandlePress('expanded12',expanded12),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
                ...
                <OtrixDivider></OtrixDivider>
                <List.Accordion  expanded={expanded13}  style={styles.ListAccordion}
                    title="6. Life Of Faith And Prayer"
                    onPress={()=>{accordionHandlePress('expanded13',expanded13),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
                ...
                <OtrixDivider></OtrixDivider>
                <List.Accordion  expanded={expanded14} style={styles.ListAccordion}
                    title="7. Moral Purity and Financial Integrity"
                    onPress={()=>{accordionHandlePress('expanded14',expanded14),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
                ...
                <OtrixDivider></OtrixDivider>
                <List.Accordion  expanded={expanded15} style={styles.ListAccordion}
                    title="8. Shared Leadership"
                    onPress={()=>{accordionHandlePress('expanded15',expanded15),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
                ...
                <OtrixDivider></OtrixDivider>
                <List.Accordion  expanded={expanded16} style={styles.ListAccordion}
                    title="9. Responsibility to society"
                    onPress={()=>{accordionHandlePress('expanded16',expanded16),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
                ...
                <OtrixDivider></OtrixDivider>
                <List.Accordion  expanded={expanded17} style={styles.ListAccordion}
                    title="Conclusion"
                    onPress={()=>{accordionHandlePress('expanded17',expanded17),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
       ...
       <View>
        <Card mode="outlined">
            ...
            <Card.Content>
            <List.Accordion  expanded={expanded18}  style={styles.ListAccordion}
                    title="Humble Beginning"
                    onPress={()=>{accordionHandlePress('expanded18',expanded18),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
                ...
                <OtrixDivider></OtrixDivider>
                <List.Accordion  expanded={expanded19} style={styles.ListAccordion}
                    title="ICEU Madras"
                    onPress={()=>{accordionHandlePress('expanded19',expanded19),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
                ...
                <OtrixDivider></OtrixDivider>
                <List.Accordion  expanded={expanded20} style={styles.ListAccordion}
                    title="Fear Not, Little Flock.."
                    onPress={()=>{accordionHandlePress('expanded20',expanded20),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
                ...
                <OtrixDivider></OtrixDivider>
                <List.Accordion  expanded={expanded22} style={styles.ListAccordion}
                    title="The Spreading Flame"
                    onPress={()=>{accordionHandlePress('expanded22',expanded22),accordionHandlePressDynamic(UESIhistoricalEventsDates,'')}}
                    left={props => <Text style={styles.contentText}></Text> }>
                        <View style={{marginLeft:-60}}>
