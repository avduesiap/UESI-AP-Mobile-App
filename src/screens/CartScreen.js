...
function CheckoutScreen(props) {
    const [state, setState] = React.useState({ loading: true, cartProducts: [], sumAmount: 0, isApplied: false, validCode: false, couponCode: null, noRecord: false, subTotal: 0, discount: null, tax: null, grandTotal: 0, message: null, type: 'error' });
    ...
    const { cartProducts, subTotal, discount, type, message, grandTotal, couponCode, loading, isApplied, validCode, tax, noRecord } = state;
    const { strings } = props;
    return (
