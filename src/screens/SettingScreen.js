...
const shareOptions = {
    title: 'Otrixapp',
    url: Platform.OS == 'android' ? 'https://play.google.com/store/apps/details?id=com.uesiap.geethavali' : 'iOS url',
};
            ...
            <OtrixContent >
                ...
                <TouchableOpacity style={styles.listView}
                    onPress={() => {
                        const options = {
                            AppleAppID: "",
                            GooglePackageName: "com.uesiap.geethavali",
                            AmazonPackageName: "",
                            OtherAndroidURL: "",
                            ...
                            fallbackPlatformURL: "ms-windows-store:review?PFN:com.uesiap.geethavali",
                        }
