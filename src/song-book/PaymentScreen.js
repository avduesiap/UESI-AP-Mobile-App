...
function PaymentScreen(props) {
    ...
    const showWarningBeforePayment = () =>{
         Alert.alert('Important:', "After Payment, don't click any done button, back button, refresh button and don't close the app. App will redirect automatically.", [
        {text: 'OK', onPress: () => doPayment()},
        ]);
    }
    const doPayment = () => {
        ...
        <SafeAreaView style={{height:'100%', backgroundColor:'#fff'}}>
            <ScrollView style={{height:'100%'}}>
                <View style={{height:'100%'}}>
                    ...
                    {paymentMType=='theme_songs_vol_1'?<Text style={{fontFamily:Fonts.Font_Medium}}>Pay & Get Theme Songs 2016-24</Text>:null}
                    </View>
                    <OtrixDivider size={'sm'} />
                    ...
                    <OtrixDivider size={'md'} />
                        ...
                        {totalAmount>0?<Button
                            ...
                            style={GlobalStyles.button}
                            isLoading={loading}
                            onPress={() => showWarningBeforePayment()}
                        >
